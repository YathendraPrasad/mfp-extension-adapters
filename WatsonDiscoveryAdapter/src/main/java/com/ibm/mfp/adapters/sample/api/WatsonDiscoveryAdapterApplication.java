 ...
 */
public class WatsonDiscoveryAdapterApplication extends MFPJAXRSApplication {

    /**
     * The logger used by the app
     */
    static Logger logger = Logger.getLogger(WatsonDiscoveryAdapterApplication.class.getName());
